...
struct USER_INTERFACE{
	...
	void DRAW_BACKGROUND(sf::RenderWindow& window,EDITOR& editor);

	void DRAW(sf::RenderWindow& window,EDITOR& editor);
	...
	bool CHECK_IF_UPDATE_BUTTON(UI_BUTTON& cur_button,EDITOR& editor);
};